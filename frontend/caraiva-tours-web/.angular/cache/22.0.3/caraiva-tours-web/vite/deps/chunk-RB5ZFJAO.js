...
function R2(t2, e) {
  if (t2 && e) {
    let o = (n) => {
      I2(t2, n) || (t2.classList ? t2.classList.add(n) : t2.className += " " + n);
    };
...
function V() {
  ...
  return (window.pageXOffset || S2(t2)) - (t2.clientLeft || 0);
}
function j2() {
  let t2 = document.documentElement;
...
function z2(t2, e, o = true) {
  var n, r, i2, s3;
  if (t2) {
    let l3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : T(t2), a = l3.height, f = l3.width, u2 = e.offsetHeight, c3 = e.offsetWidth, d3 = e.getBoundingClientRect(), g2 = j2(), w = V(), ct = h(), M, B2, dt = "top";
    d3.top + u2 + a > ct.height ? (M = d3.top + g2 - a, dt = "bottom", M < 0 && (M = g2)) : M = u2 + d3.top + g2, d3.left + f > ct.width ? B2 = Math.max(0, d3.left + w + c3 - f) : B2 = d3.left + w, q2(t2) ? t2.style.insetInlineEnd = B2 + "px" : t2.style.insetInlineStart = B2 + "px", t2.style.top = M + "px", t2.style.transformOrigin = dt, o && (t2.style.marginTop = dt === "bottom" ? `calc(${(r = (n = E2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (s3 = (i2 = E2(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? s3 : "");
  }
}
...
function Y(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : T(t2), s3 = e.offsetHeight, l3 = e.getBoundingClientRect(), a = h(), f, u2, c3 = n != null ? n : "top";
    if (!n && l3.top + s3 + i2.height > a.height ? (f = -1 * i2.height, c3 = "bottom", l3.top + f < 0 && (f = -1 * l3.top)) : f = s3, i2.width > a.width ? u2 = l3.left * -1 : l3.left + i2.width > a.width ? u2 = (l3.left + i2.width - a.width) * -1 : u2 = 0, t2.style.top = f + "px", t2.style.insetInlineStart = u2 + "px", t2.style.transformOrigin = c3, o) {
      let d3 = (r = E2(/-anchor-gutter$/)) == null ? void 0 : r.value;
      t2.style.marginTop = c3 === "bottom" ? `calc(${d3 != null ? d3 : "2px"} * -1)` : d3 != null ? d3 : "";
    }
  }
}
function b2(t2) {
...
function Ot(t2) {
  var e;
  if (t2) {
    let o = (e = b2(t2)) == null ? void 0 : e.childNodes, n = 0;
...
//# sourceMappingURL=chunk-RB5ZFJAO.js.map
